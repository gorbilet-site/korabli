...
const COORDS_BY_NAME = new Map([
  ...
  ['Причал на наб. р. Мойки, 75 («Речной трамвай»)', [59.933027, 30.313892]],
  ...
  ['Причал на набережной реки Фонтанки, 165', [59.916591, 30.293428]],
  ['Причал на Ждановской набережной, 2А', [59.954948, 30.283035]],
  ['САП-старт «Каменный остров»', [59.973261, 30.281644]],
  ['САП-старт «Исторический центр»', [59.944161, 30.326033]],
  ['САП-старт «Закат на Лахте»', [60.006741, 30.198979]],
  ['Причал на Дворцовой набережной, 38 (Эрмитаж Нижний)', [59.941339, 30.312424]],
...
html = html.replace(/\d+ точек отправления/, `${compactPiers.length} точек отправления`);
